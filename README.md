...
### Salary gap
An Argentine Data Analyst earns between **16% and 18%** of the US equivalent at the same seniority level. The absolute gap grows with seniority: a Senior in Argentina earns ~$4,350/month vs ~$13,500 in the US.

| Seniority | 🇦🇷 Argentina | 🇺🇸 USA | ARG as % of US |
|---|---|---|---|
| Junior | ~$1,050 | ~$5,800 | ~18% |
| Semi-Senior | ~$2,350 | ~$8,600 | ~27% |
| Senior | ~$4,350 | ~$13,500 | ~32% |

### Advanced English premium in Argentina
English proficiency adds between **20% and 30%** to an Argentine analyst's salary — and adoption is growing, particularly at Senior level where 65% now report advanced English.

### Tool stack differences
- **SQL and Python** are universal in both markets (+85% adoption)
- **Power BI** dominates in Argentina; the US leans more toward cloud-native tools
- **AI tools** adoption jumped sharply in 2025: 72% of Senior analysts in Argentina now report using AI in their workflow
- **Cloud (AWS/GCP/Azure)** is significantly higher in the US at all seniority levels

### Remote work
Over **50% of Argentine data analysts** work fully remote — and the rate rises to 62% at Senior level, reflecting growing access to international remote opportunities.
...
- Advanced `matplotlib` visualizations: grouped bars, scatter distributions, heatmaps, stacked bars, KPI dashboards
...
**Brecha salarial**  
Un analista de datos argentino gana entre el **16% y el 32%** del salario equivalente en EEUU según su seniority. La brecha crece en términos absolutos a medida que sube el nivel.

| Seniority | 🇦🇷 Argentina | 🇺🇸 EEUU | ARG como % de EEUU |
|---|---|---|---|
| Junior | ~$1.050 | ~$5.800 | ~18% |
| Semi-Senior | ~$2.350 | ~$8.600 | ~27% |
| Senior | ~$4.350 | ~$13.500 | ~32% |
...
**Inglés avanzado**  
El inglés avanzado representa entre un **20% y un 30% de premium salarial** en Argentina. El 65% de los analistas Senior ya lo reportan como competencia, reflejando el crecimiento del trabajo remoto para empresas del exterior.

**Stack tecnológico**  
SQL y Python son universales en ambos mercados. Power BI domina en Argentina mientras EEUU concentra más herramientas cloud-native. La **adopción de IA** creció fuertemente en 2025: el 72% de los analistas Senior en Argentina ya la usan en su flujo de trabajo.

**Modalidad de trabajo**  
M�s del **50% de los analistas argentinos** trabaja 100% remoto — cifra que sube al 62% en Senior.
